...
8. Stop or ask before advancing.
...
- SQL joins, aggregation, dates, CTEs, CASE, and window functions;
- Python/pandas filtering, groupby, merge, missing data, metrics, and debugging;
- statistics, experimentation, behavioral measurement, product metrics, or evaluation design;
- role-specific case and system-design reasoning.

Define completion precisely, for example: solve two independently and correct one after feedback.
